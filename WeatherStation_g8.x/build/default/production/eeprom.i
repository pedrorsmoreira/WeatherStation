...
# 5 "/Users/vasco/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.1.82/xc8/pic/include/c99/stdlib.h" 2 3
...
# 11 "/Users/vasco/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.1.82/xc8/pic/include/c99/stdlib.h" 2 3
...
void eeprom_clk_update(uint8_t clkh, uint8_t clkm){
    ...
    DATAEE_WriteByte(0xF000, DATAEE_ReadByte(0xF000) + clkh + clkm - DATAEE_ReadByte(0xF007) - DATAEE_ReadByte(0xF008));
...
uint8_t read_buffer(uint8_t i, uint8_t j) { return DATAEE_ReadByte(0xF00B + i * 5 + j); }
...
uint8_t read_iwrt(void) { return DATAEE_ReadByte(0xF00A); }
