...
void write_pmon(uint8_t x) {
    #ifdef CHECKSUM
    DATAEE_WriteByte(CHECK_, x - DATAEE_ReadByte(PMON_));
    #endif
...
void write_tala(uint8_t x) {
    #ifdef CHECKSUM
    DATAEE_WriteByte(CHECK_, x - DATAEE_ReadByte(TALA_));
    #endif
...
void write_alat(uint8_t x) {
    #ifdef CHECKSUM
    DATAEE_WriteByte(CHECK_, x - DATAEE_ReadByte(ALAT_));
    #endif
...
void write_alal(uint8_t x) {
    #ifdef CHECKSUM
    DATAEE_WriteByte(CHECK_, x - DATAEE_ReadByte(ALAL_));
    #endif
...
void write_alaf(uint8_t x) {
    #ifdef CHECKSUM
    DATAEE_WriteByte(CHECK_, x - DATAEE_ReadByte(ALAF_));
    #endif
